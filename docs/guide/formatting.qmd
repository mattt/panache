...
untouched. As with grid tables, column widths themselves are **never** resized,
since Pandoc derives relative output widths from them. The header row is left
as-is, because its layout determines each column's alignment.
